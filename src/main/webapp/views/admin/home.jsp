	...
	<div class="main-content-inner">
		...
		<div class="page-content">
			...
			<div class="page-header">
				<h1>
					Dashboard <small> <i class="ace-icon fa fa-angle-double-right"></i> overview &amp;
						stats
					</small>
				</h1>
			</div>
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="alert alert-block alert-success">
						...
						<i class="ace-icon fa fa-check green"></i> Welcome to <strong class="green"> Ace
							<small>(v1.3.3)</small>
										...
										<div class="tab-content padding-8">
											<div id="task-tab" class="tab-pane active">
												...
												<ul id="tasks" class="item-list">
													...
													<li class="item-default clearfix"><label class="inline"> <input
