...
<head>
<meta charset="UTF-8">
<title>Chương trình học tập</title>
</head>
									...
									<div class="pull-right tableTools-container">
										<div class="dt-buttons btn-overlap btn-group">
											<a flag="info"
												...
												data-toggle="tooltip" title='Thêm nội dung học tập'
											...
											<button id="btnDelete" type="button"
												...
												data-toggle="tooltip" title='Xóa nội dung học tập'>
												...
												<c:forEach var="item" items="${model.listResult}">
													<tr>
														...
														<td><c:url var="editURL" value="/admin-new">
															...
															data-toggle="tooltip" title="Cập nhật nội dung học tập"
