...
<body class="no-skin">
	...
	<script type="text/javascript">
		window.jQuery || document.write("<script src=" + "<c:url value='/template/admin/js/jquery.min.js'/>" + ">" + "<" +
			"/script>");
	</script>
	<script type="text/javascript">
		if ('ontouchstart' in document.documentElement) document.write("<script src=" +
			"<c:url value='/template/admin/js/jquery.mobile.custom.min.js'/>" + ">" + "<" + "/script>");
	</script>
